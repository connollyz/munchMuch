...
class Start extends Component {
    ...
    handleClick = (e)=>{
        ...
        if (this.state.username === " " || this.state.username === ""  ) {
            ...
            dbRef.push({
                'curentPlayer': this.state.username
            });
            const startComp = document.getElementById('start')
            startComp.remove()
        }
        // need to figer out how to change the key so i can update the curentPlayer as needed in firebase
